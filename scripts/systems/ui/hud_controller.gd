...
@onready var player_name_text: RichTextLabel = %LevelLabel
@onready var level_text: RichTextLabel = %LevelLabel
@onready var cpu_slider: ProgressBar = %CPUBar
@onready var ram_slider: ProgressBar = %RAMBar
@onready var bandwidth_slider: ProgressBar = %BWBar
@onready var credits_text: RichTextLabel = %CreditsLabel
@onready var current_ip_text: RichTextLabel = %LevelLabel
