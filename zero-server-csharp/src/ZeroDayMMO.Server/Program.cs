...
var heatCascadeService = new HeatCascadeService(playerService, gameEventBus);
...
messageRouter.Register(new AuctionHandler(auctionService));
messageRouter.Register(new BossHandler(coopBossService));
messageRouter.Register(new CareerHandler(careerService, heatCascadeService));
